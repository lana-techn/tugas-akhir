...
<head>
    ...
    <link rel="stylesheet" href="../public/css/daftar_jabatan.css">
    ...
    <ul class="nav">
        ...
        <li class="has-submenu">
            ...
            <ul class="submenu active">
                ...
                <li><a href="daftar_jabatan.php" class="active">Jabatan</a></li>
...
<div class="main-content">
    ...
    <div class="content">
        <div class="header">
            ...
            <a href="tambah_jabatan.php" class="btn-tambah">Tambah</a>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_jabatan.php?id=<?= $row['id_jabatan'] ?>" class="btn-edit">Edit</a>
                        <a href="hapus_jabatan.php?id=<?= $row['id_jabatan'] ?>" 
