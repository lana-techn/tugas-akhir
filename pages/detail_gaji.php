...
// Ambil data ringkasan dari tabel GAJI
...
// Ambil data rincian dari tabel DETAIL_GAJI
    ...
    <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 border border-gray-200 rounded-lg p-4">
            <div class="flex justify-between border-b pb-2">
                ...
                <span class="text-sm font-semibold text-gray-800"><?= e($gaji_data['Nama_Karyawan']) ?></span>
            </div>
             <div class="flex justify-between border-b pb-2">
                <span class="text-sm font-medium text-gray-500">Jabatan</span>
                <span class="text-sm font-semibold text-gray-800"><?= e($gaji_data['Nama_Jabatan']) ?></span>
            </div>
            <div class="flex justify-between">
                <span class="text-sm font-medium text-gray-500">Tanggal Gaji</span>
                <span class="text-sm font-semibold text-gray-800"><?= date('d F Y', strtotime($gaji_data['Tgl_Gaji'])) ?></span>
            </div>
             <div class="flex justify-between">
        ...
        <div class="space-y-4">
            <div>
                ...
                <div class="border rounded-md">
                    <div class="flex justify-between py-2.5 px-4 border-b">
                        <span class="text-sm">Gaji Pokok</span>
                        <span class="font-semibold">Rp <?= number_format($detail_data['Nominal_Gapok'] ?? 0, 2, ',', '.') ?></span>
                    </div>
                    <div class="flex justify-between py-2.5 px-4 border-b">
                        <span class="text-sm">Tunjangan</span>
                        <span class="font-semibold">Rp <?= number_format($gaji_data['Total_Tunjangan'], 2, ',', '.') ?></span>
                    </div>
                    <div class="flex justify-between py-2.5 px-4">
                        <span class="text-sm">Lembur</span>
                        <span class="font-semibold">Rp <?= number_format($gaji_data['Total_Lembur'], 2, ',', '.') ?></span>
                    </div>
                </div>
                <div class="flex justify-between py-2.5 px-4 bg-gray-100 rounded-b-md font-bold">
                    <span>Total Pendapatan (Gaji Kotor)</span>
                    <span>Rp <?= number_format($gaji_data['Gaji_Kotor'], 2, ',', '.') ?></span>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="border rounded-md">
                    <div class="flex justify-between py-2.5 px-4">
                        ...
                        <span class="font-semibold text-red-600">- Rp <?= number_format($gaji_data['Total_Potongan'], 2, ',', '.') ?></span>
                    </div>
                </div>
            </div>
        </div>
