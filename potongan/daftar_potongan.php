...
<head>
    ...
    <link rel="stylesheet" href="../public/css/daftar_potongan.css">
    ...
    <ul class="nav">
        ...
        <li class="has-submenu">
            ...
            <ul class="submenu active">
                ...
                <li><a href="daftar_potongan.php" class="active">Potongan</a></li>
            </ul>
        </li>
...
<div class="main-content">
    ...
    <div class="content">
        <div class="header">
            ...
            <a href="tambah_potongan.php" class="btn-tambah">Tambah</a>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit_potongan.php?id=<?= $row['id_potongan'] ?>" class="btn-edit">Edit</a>
                        <a href="hapus_potongan.php?id=<?= $row['id_potongan'] ?>" 
