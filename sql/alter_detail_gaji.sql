...
-- Lembur default
INSERT INTO LEMBUR (Id_Lembur, Nama_Lembur, Upah_Lembur_Per_Jam, Keterangan)
SELECT 1, 'Tidak Ada Lembur', 0, 'Default untuk tidak ada lembur'  
WHERE NOT EXISTS (SELECT 1 FROM LEMBUR WHERE Id_Lembur = 1);
...
UPDATE DETAIL_GAJI SET Id_Lembur = 1 WHERE Id_Lembur IS NULL;
...
ALTER TABLE DETAIL_GAJI 
    ...
    MODIFY COLUMN Id_Lembur INT NOT NULL DEFAULT 1;
